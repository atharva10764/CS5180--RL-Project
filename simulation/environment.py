    ...
    def reset(self):
        ...
        try:
            ...
            if len(self.actor_list) != 0 or len(self.sensor_list) != 0:
                # the system matic approach to ve dien
...
# Creating and Spawning other vehciles in our world|
 # TRIED   creaating for the TOWN 07 which we could not qble to implement fully. The simulation awas run on environment Town02 for the better analysis 
